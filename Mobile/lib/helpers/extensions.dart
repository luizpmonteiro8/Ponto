...
extension DateTimeExtension on DateTime {
  String formattedDate() {
    return DateFormat('dd/MM/yyyy HH:mm', 'pt-BR').format(toLocal());
  }
  ...
  String formattedMessageDate() {
    ...
    if (difference == 0) {
      return DateFormat('HH:mm', 'pt-BR').format(toLocal());
    } else if (difference == 1) {
      return 'Ontem';
    } else if (difference <= 7) {
      return DateFormat('EEEE', 'pt-BR').format(toLocal());
    } else {
      return DateFormat('dd/MM/yyyy', 'pt-BR').format(toLocal());
    }
  }
  ...
  String formattedChatDate() {
    ...
    if (difference == 0) {
      ...
      return DateFormat('E, dd/MM/yy', 'pt-BR').format(toLocal());
    }
  }
}
